...
function showGraphLatex() {
  var l = "";
  if (checkColoring()) {
    if (currentProb == problems.length - 1) l = "\\[\\text{Você conseguiu!}\\]";
    else l = "\\[\\text{Você conseguiu! Prossiga para o próximo problema.}\\]";
  } else l = "\\[\\text{Você pode usar no máximo " + numOfColors + " cores.}\\]";
